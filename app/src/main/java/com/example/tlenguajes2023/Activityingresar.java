...
public class Activityingresar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        genero = (Spinner) findViewById(R.id.cmdgenero);
    ...
    private void Insertar_datos()
    {
        ...
        if(resultado > 0)
        {
            Toast.makeText(getApplicationContext(), "Registro ingreso con exito", Toast.LENGTH_SHORT).show();
        }
        else
        {
            Toast.makeText(getApplicationContext(), "Registro no se ingreso", Toast.LENGTH_SHORT).show();
        }
